...
\- Each stage's handouts go in their own subfolder, named exactly as the course folder, e.g. `class\_materials/stage01\_problem-framing-and-scoping/`.
